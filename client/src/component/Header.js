...
export default function ElevateAppBar(props) {
  ...
  const drawerLinks = [
    ...
    },
    {
      label: 'Diary',
      href: '/diary',
      icon: <MenuBookIcon style={{ color: '#651fff' }} />,
    },
    {
      label: 'lists',
      href: '/lists',
      icon: <ListAltIcon style={{ color: '#651fff' }} />,
    },
    {
      label: 'notes',
      href: '/notes',
      icon: <EventNoteIcon style={{ color: '#651fff' }} />,
    },
    {
      label: 'reminders',
      href: '/reminders',
      icon: <AddAlertIcon style={{ color: '#651fff' }} />,
    },
    {
      label: 'other Notes',
      href: '/others',
      icon: <NoteIcon style={{ color: '#651fff' }} />,
    },
  ]
    .filter((linkConfig) => linkConfig)
    .map(({ label, href, icon }) => {
